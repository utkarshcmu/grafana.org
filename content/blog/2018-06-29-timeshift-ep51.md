...
With summer holidays approaching and upcoming vacations on the calendar, TimeShift is going to take next week off, so we look forward to returning in a few weeks. 
...
[**Monitoring Kubernetes with Prometheus 2.1+, Grafana 5.1+ and Helm**](https://rohanc.me/monitoring-kubernetes-prometheus-grafana/): A quick install guide to install Prometheus 2.1.x, Grafana 5.1.x and Helm that includes some of the new dashboard and data source provisioning features.
	...
	<div class="row row--md-gutters">
		...
		<div class="col col--sm-10 blog-plugin-grid__item">
			...
			<ul>
				...
				<li>More mapping options for table data for datasources that cannot alias/rename the columns to the names that the Worldmap panel expects (e.g. `metric` for the metric column)</li>
